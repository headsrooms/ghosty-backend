...
class Work(models.Model):
    ...
    a24h = models.CharField(verbose_name="A24H", max_length=50, unique=True, default=datetime.datatime.now())
    ...
    creation_date = models.DateField(verbose_name="Fecha de creación", default=datetime.datatime.now())
...
def complete_task(sender, instance, **kwargs):
    if instance.status is Task.DONE:
        instance.done_date = datetime.datatime.now()
        instance.save()
